package net.chomesan.ars_technica.recipe.jei;
...
public class JeiArsExtraPlugin implements IModPlugin {
    ...
    public static final RecipeType<TechnomancerArmorRecipe> TECHNOMANCER_ARMOR_TYPE = RecipeType.create(YAArsTechnicaMod.MODID, "armor_upgrade", TechnomancerArmorRecipe.class);

    @Override
    public @NotNull ResourceLocation getPluginUid() {
        return new ResourceLocation(YAArsTechnicaMod.MODID, "main");
    }
