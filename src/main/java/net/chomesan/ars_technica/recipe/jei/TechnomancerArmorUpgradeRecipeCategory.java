...
public class TechnomancerArmorUpgradeRecipeCategory extends EnchantingApparatusRecipeCategory<TechnomancerArmorRecipe> {
    public TechnomancerArmorUpgradeRecipeCategory(IGuiHelper helper) {
        super(helper);
    }
