package net.chomesan.ars_technica.recipe;
...
import net.chomesan.ars_technica.setup.RecipeRegistry;
...
public class TechnomancerArmorRecipe extends EnchantingApparatusRecipe implements ITextOutput {
  ...
  public JsonElement asRecipe() {
    ...
    jsonobject.addProperty("type", YAArsTechnicaMod.MODID + ":armor_upgrade");
