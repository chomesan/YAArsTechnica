...
public class TechnomancerArmorModel<T extends GeoAnimatable> extends GeoModel<T> {
  ...
  public TechnomancerArmorModel(String name) {
    this.modelLocation = new ResourceLocation(YAArsTechnicaMod.MODID, "geo/" + name + ".geo.json");
    this.textLoc = new ResourceLocation(YAArsTechnicaMod.MODID, "textures/armor/" + name + ".png");
  }
