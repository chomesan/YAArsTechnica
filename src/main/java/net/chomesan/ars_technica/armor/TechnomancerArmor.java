package net.chomesan.ars_technica.armor;
...
import net.chomesan.ars_technica.client.TooltipUtils;
import net.chomesan.ars_technica.client.renderer.item.TechnomancerArmorRenderer;
...
import static net.chomesan.ars_technica.ConfigHandler.Common.ARMOR_MANA_REGEN;
import static net.chomesan.ars_technica.ConfigHandler.Common.ARMOR_MAX_MANA;
...
public class TechnomancerArmor extends AnimatedMagicArmor implements ISpellModifierItem {
  ...
  public @Nullable String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
    ...
    return new ResourceLocation(YAArsTechnicaMod.MODID, location).toString();
  }
  ...
  public void addInformationAfterShift(ItemStack stack, Level world, List<Component> list, TooltipFlag flags) {
    ...
    if (player != null) {
      ...
      list.add(
          Component.translatable(YAArsTechnicaMod.MODID + ".armor_set.technomancer.desc").withStyle(ChatFormatting.GRAY));
    }
  ...
  private Component getArmorSetTitle(int equipped) {
    return Component.translatable(YAArsTechnicaMod.MODID + ".armor_set.technomancer")
        .append(" (" + equipped + " / 4)")
  ...
  private Component getArmorPieceSpecialInformation() {
    ...
    return Component.translatable(YAArsTechnicaMod.MODID + specialInformation)
