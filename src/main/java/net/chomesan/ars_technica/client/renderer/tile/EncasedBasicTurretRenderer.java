package net.chomesan.ars_technica.client.renderer.tile;
...
public class EncasedBasicTurretRenderer extends ArsGeoBlockRenderer<EncasedTurretBlockEntity> {
    public static GeoModel model = new GenericModel(YAArsTechnicaMod.MODID, "encased_basic_spell_turret");
    private final GeoModel encasing = new GenericModel(YAArsTechnicaMod.MODID, "spell_turret_encasing").withEmptyAnim();
