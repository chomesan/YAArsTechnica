...
import net.chomesan.ars_technica.common.entity.ArcaneHammerEntity;
...
public class ArcaneHammerModel extends GeoModel<ArcaneHammerEntity> {
    ...
    public ResourceLocation getModelResource(ArcaneHammerEntity entity) {
        return new ResourceLocation(YAArsTechnicaMod.MODID, "geo/arcane_hammer.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(ArcaneHammerEntity entity) {
        return new ResourceLocation(YAArsTechnicaMod.MODID, "animations/animations_arcane_hammer.json");
    }
