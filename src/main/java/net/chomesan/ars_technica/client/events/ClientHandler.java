...
import net.chomesan.ars_technica.client.renderer.entity.*;
import net.chomesan.ars_technica.client.renderer.tile.EncasedBasicTurretRenderer;
import net.chomesan.ars_technica.common.blocks.PreciseRelayRenderer;
import net.chomesan.ars_technica.common.blocks.SourceEngineRenderer;
import net.chomesan.ars_technica.common.items.equipment.SpyMonocleCurioRenderer;
import net.chomesan.ars_technica.setup.EntityRegistry;
import net.minecraft.client.Minecraft;

import net.chomesan.ars_technica.client.sound.EntityLoopingSound;
import net.chomesan.ars_technica.common.entity.WhirlEntity;
import net.chomesan.ars_technica.init.ArsTechnicaModSounds;
...
@Mod.EventBusSubscriber(value = Dist.CLIENT, modid = YAArsTechnicaMod.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
@OnlyIn(Dist.CLIENT)
