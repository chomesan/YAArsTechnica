...
@Mod.EventBusSubscriber(modid = YAArsTechnicaMod.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class Datagen {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        gen.addProvider(event.includeClient(), new ModBlockStateProvider(gen.getPackOutput(), YAArsTechnicaMod.MODID, existingFileHelper));
