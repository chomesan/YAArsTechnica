...
import net.chomesan.ars_technica.common.blocks.PreciseRelay;
import net.chomesan.ars_technica.common.blocks.turrets.EncasedTurretBlock;
import net.chomesan.ars_technica.common.blocks.SourceEngineBlock;
...
public class BlockRegistry {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, YAArsTechnicaMod.MODID);
