package net.chomesan.ars_technica.common.entity.fusion;

import com.hollingsworth.arsnouveau.api.spell.SpellResolver;
import com.hollingsworth.arsnouveau.api.spell.SpellStats;
import com.simibubi.create.content.kinetics.mixer.MixingRecipe;
import net.chomesan.ars_technica.ConfigHandler;
import net.chomesan.ars_technica.common.entity.Colorable;
import net.chomesan.ars_technica.common.entity.fusion.fluids.ArcaneFusionFluids;
import net.chomesan.ars_technica.common.entity.fusion.fluids.FluidSourceProvider;
import net.chomesan.ars_technica.common.helpers.FluidHelper;
import net.chomesan.ars_technica.common.helpers.recipe.MixingRecipeHelpers;
