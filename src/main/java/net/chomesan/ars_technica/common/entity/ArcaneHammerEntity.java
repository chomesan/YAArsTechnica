...
import net.chomesan.ars_technica.common.helpers.RecipeHelpers;
import net.chomesan.ars_technica.common.helpers.SpellResolverHelpers;
...
import static net.chomesan.ars_technica.common.helpers.PlayerHelpers.getNearbyPlayers;
...
public class ArcaneHammerEntity extends Entity implements GeoEntity, Colorable {
    ...
    private void triggerAdvancement(ServerPlayer player) {
        Advancement advancement = player.server.getAdvancements().getAdvancement(new ResourceLocation(YAArsTechnicaMod.MODID, "hammered_witch"));
