package net.chomesan.ars_technica.common.items.equipment;
...
public class SpyMonocleCurioRenderer implements ICurioRenderer {
    public static final ModelLayerLocation SPY_MONOCLE_LAYER = new ModelLayerLocation(new ResourceLocation(YAArsTechnicaMod.MODID, "spy_monocle"), "monocle");
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        model.head.render(matrixStack, renderTypeBuffer.getBuffer(RenderType.entityCutoutNoCull(new ResourceLocation(YAArsTechnicaMod.MODID, "textures/entity/spy_monocle.png"))), light, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F, 1.0F);
        matrixStack.popPose();
    }
